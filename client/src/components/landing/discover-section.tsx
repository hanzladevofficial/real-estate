        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 xl:gap-16">
          {[
            ...
            },
            {
              ...
              description:
                "Our you've found the perfect rental property,easily book it online with just few clicks.",
            },
            {
...
const DiscoverCard = ({
  ...
  <div className="px-4 py-12 shodow-lg rounded-lg bg-primary-50 md:h-72">
